    ...
    if($wearing_glasses xor $wearing_contacts)
    {
      switch($location)
      {
        case "kitchen":
          ...
          break;
        case "bathroom":
          echo "Normal bathroom. There's a mirror here. You can get back out to the *kitchen*. You sense a magic presence in the toilet, but you decide to ignore it. (Even though you kind of want to search it.)\n";
          break;
        case "woods":
